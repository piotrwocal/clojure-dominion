...
(deftest test-play-card
  (are [hand init-player result-player]
    ...
    {:moat 1} {:cards {:gold 3} :discarded {}}
    {:cards {:gold 1} :discarded {:moat 1 :gold 2}}

    {:moat 1 :smithy 1} {:cards {:gold 3} :discarded {}}
    {:cards {} :discarded {:moat 1 :smithy 1 :gold 3}}

    {:woodcutter 1} {:cards {:gold 3} :discarded {}}
    {:cards {:gold 3} :discarded {:woodcutter 1}}

    {:chapel 1 :estate 3} {:cards {:gold 3} :discarded {}}
    {:cards {:gold 3} :discarded {:chapel 1}}
    ))

(deftest test-buy-card
  (are [hand init-player result-player]
    ...
    {:woodcutter 1 :copper 12}
    {:cards {:estate 1} :discarded {}}
